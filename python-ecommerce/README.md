# Python E-Commerce Catalog Service

A small, interview-ready FastAPI project that demonstrates production-style Python structure using an e-commerce product catalog example.

## What this project shows

- FastAPI service design
- Async endpoint for AI-style recommendations
- CSV-based product loading
- Python decorators
...
**Parameters:**
- `PYTHONPATH=.` - Sets the Python path to the current directory
